          ...
          @if (count($categories) > 0)
            ...
            <tr wire:key="{{$category->id}}">
              ...
              <td class="size-px whitespace-nowrap">
                ...
                <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="edit/{{$category->id}}/categories">
                  Edit
                </a>
                </div>
              </td>
